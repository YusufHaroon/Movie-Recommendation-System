...
This ML project implements Content-Based Movie Recommendation System using dataset from Kaggle. It allows users to search for a movie and returns 9 similar movies based on their content features.
...
Both datasets are sourced from [The Movie Database (TMDB)] and contain information on over 5,000 movies including their cast, crew, genres, and keywords. 
